...
{
    public class ChannelUpdateScheduledTaskP6 : IScheduledTask, IConfigurableScheduledTask
    {
        private ITaskManager TaskManager { get; set; }

        public ChannelUpdateScheduledTaskP6(ITaskManager taskMan)
        {
            TaskManager = taskMan;
        }
        ...
        private readonly TraktChannel _traktChannel =
            Plugin.Instance.PluginConfiguration.PreConfiguredTraktChannels.Single(x => x.Id == 6);
