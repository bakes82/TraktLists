...
{
    public class ChannelUpdateScheduledTaskP4 : IScheduledTask, IConfigurableScheduledTask
    {
        private ITaskManager TaskManager { get; set; }

        public ChannelUpdateScheduledTaskP4(ITaskManager taskMan)
        {
            TaskManager = taskMan;
        }
        ...
        private readonly TraktChannel _traktChannel =
            Plugin.Instance.PluginConfiguration.PreConfiguredTraktChannels.Single(x => x.Id == 4);
