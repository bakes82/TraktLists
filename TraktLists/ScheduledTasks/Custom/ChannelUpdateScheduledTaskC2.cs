...
{
    public class ChannelUpdateScheduledTaskC2 : IScheduledTask, IConfigurableScheduledTask
    {
        private ITaskManager TaskManager { get; set; }

        public ChannelUpdateScheduledTaskC2(ITaskManager taskMan)
        {
            TaskManager = taskMan;
        }
        ...
        private readonly TraktChannel _traktChannel =
            Plugin.Instance.PluginConfiguration.CustomTraktChannels.Single(x => x.Id == 2);
