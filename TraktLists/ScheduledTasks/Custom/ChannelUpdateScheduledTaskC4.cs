...
{
    public class ChannelUpdateScheduledTaskC4 : IScheduledTask, IConfigurableScheduledTask
    {
        private ITaskManager TaskManager { get; set; }

        public ChannelUpdateScheduledTaskC4(ITaskManager taskMan)
        {
            TaskManager = taskMan;
        }
        ...
        private readonly TraktChannel _traktChannel =
            Plugin.Instance.PluginConfiguration.CustomTraktChannels.Single(x => x.Id == 4);
