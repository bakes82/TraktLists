...
{
    public class ChannelC1 : IChannel, IHasCacheKey, IRequiresMediaInfoCallback
    {
        ...
        private readonly TraktChannel _channelToConfigure = Plugin.Instance.PluginConfiguration.CustomTraktChannels.Single(x => x.Id == 1);

        public ChannelC1(IHttpClient httpClient, ILogManager logManager, IJsonSerializer jsonSerializer, ILibraryManager lib, TraktApi traktApi, IUserManager userManager)
        {
