...
{
    public class ChannelC7 : IChannel, IHasCacheKey, IRequiresMediaInfoCallback
    {
        ...
        private readonly TraktChannel _channelToConfigure = Plugin.Instance.PluginConfiguration.CustomTraktChannels.Single(x => x.Id == 7);

        public ChannelC7(IHttpClient httpClient, ILogManager logManager, IJsonSerializer jsonSerializer, ILibraryManager lib, TraktApi traktApi, IUserManager userManager)
        {
