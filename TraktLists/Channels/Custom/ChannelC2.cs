...
{
    public class ChannelC2 : IChannel, IHasCacheKey, IRequiresMediaInfoCallback
    {
        ...
        private readonly TraktChannel _channelToConfigure = Plugin.Instance.PluginConfiguration.CustomTraktChannels.Single(x => x.Id == 2);

        public ChannelC2(IHttpClient httpClient, ILogManager logManager, IJsonSerializer jsonSerializer, ILibraryManager lib, TraktApi traktApi, IUserManager userManager)
        {
