...
{
    public class ChannelP3 : IChannel, IHasCacheKey, IRequiresMediaInfoCallback
    {
        ...
        private readonly TraktChannel _channelToConfigure = Plugin.Instance.PluginConfiguration.PreConfiguredTraktChannels.Single(x => x.Id == 3);

        public ChannelP3(IHttpClient httpClient, ILogManager logManager, IJsonSerializer jsonSerializer, ILibraryManager lib, TraktApi traktApi, IUserManager userManager)
        {
