...
{
    public class ChannelP8 : IChannel, IHasCacheKey, IRequiresMediaInfoCallback
    {
        ...
        private readonly TraktChannel _channelToConfigure = Plugin.Instance.PluginConfiguration.PreConfiguredTraktChannels.Single(x => x.Id == 8);

        public ChannelP8(IHttpClient httpClient, ILogManager logManager, IJsonSerializer jsonSerializer, ILibraryManager lib, TraktApi traktApi, IUserManager userManager)
        {
