...
using TraktLists.Api.DataContracts;
using TraktLists.Api.DataContracts.BaseModel;
using TraktLists.Api.DataContracts.Users.Collection;
using TraktLists.Api.DataContracts.Users.Playback;
using TraktLists.Api.DataContracts.Users.Watched;

namespace TraktLists.Helpers
{
    class Match
    {
